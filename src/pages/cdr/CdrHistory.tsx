...
import { listConversations, sessionPath } from '../../hooks/useCdr';
        ...
        <DashboardLayout title="Histórico">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
                ...
                <p className="text-sm text-slate-500 mt-1 mb-8">
                    Consultas realizadas com os representantes digitais deste espaço.
                </p>
                        ...
                        {conversations.map((conv) => (
                            <li key={conv.id}>
                                <Link
                                    ...
                                    className="block bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 hover:border-primary transition-colors"
                                >
